...
public class TriggerContentCreatorSkillContentCreatorConfirm: QuestReactionTrigger<Step3SkillsContentCreatorSecondary>
{
    ...
    public override Task Init(Step3SkillsContentCreatorSecondary parentStep, QuestContext context)
    {
