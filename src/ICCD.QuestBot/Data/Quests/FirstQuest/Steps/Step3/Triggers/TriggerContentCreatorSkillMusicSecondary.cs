...
public class TriggerContentCreatorSkillMusicSecondary : QuestReactionTrigger<Step3SkillsContentCreatorSecondary>
{
    public TriggerContentCreatorSkillMusicSecondary()
    {
