...
public class TriggerContentCreatorSkillPodcastingPrimary : QuestReactionTrigger<Step3SkillsContentCreatorPrimary>
{
    public TriggerContentCreatorSkillPodcastingPrimary()
    {
        AddTriggerAction(new AddRoleTriggerAction("Podcaster"));
